...
def second_round_attack(board):
	if board[5] == 'Y' and board[1] == 'X':
		board[9] = 'Y'
		return board[9]
	elif board[5] == 'Y' and board[3] == 'X':
		board[7] = 'Y'
		return board[7]
	elif board[5] == 'Y' and board[7] == 'X':
		board[3] = 'Y'
		return board[3]
	elif board[5] == 'Y' and board[9] == 'X':
		board[1] = 'Y'
		return board[1]
